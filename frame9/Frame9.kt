...
/**
 * This composable was generated from the UI Package 'frame_9'.
...
fun LOGINBG(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_loginbg),
...
fun BgDesign(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_bg_design),
...
fun Icon(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_icon),
...
fun LowButtonBg(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_low_button_bg),
...
fun MediumButtonBg(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_medium_button_bg),
        modifier = modifier.requiredWidth(200.0.dp).requiredHeight(30.0.dp)
    )
}
...
fun HighBg32(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_high_bg_32),
        modifier = modifier.requiredWidth(200.0.dp).requiredHeight(30.0.dp)
    )
}
...
fun DoneButtonBg(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_done_button_bg),
...
fun TitleBg(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_title_bg),
...
fun TitleBg1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_title_bg1),
        modifier = modifier.requiredWidth(270.0.dp).requiredHeight(30.0.dp)
    )
}
...
fun LineTime1(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_line_time_1),
...
fun LineTime2(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_line_time_2),
        modifier = modifier.requiredWidth(30.0.dp).requiredHeight(1.0.dp)
    )
}
...
fun RepeatBg(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_repeat_bg),
        modifier = modifier.requiredWidth(270.0.dp).requiredHeight(30.0.dp)
    )
}
...
fun LineRepeat(modifier: Modifier = Modifier) {
    RelayVector(
        vector = painterResource(R.drawable.frame_9_line_repeat),
        modifier = modifier.requiredWidth(30.0.dp).requiredHeight(1.0.dp)
    )
}
