package com.example.mobpr0g.frame1
...
/**
 * This composable was generated from the UI Package 'frame_1'.
...
private fun Frame1Preview() {
    MaterialTheme {
        RelayContainer {
            Frame1(modifier = Modifier.rowWeight(1.0f).columnWeight(1.0f))
        }
    }
}
...
fun Airplane(modifier: Modifier = Modifier) {
    RelayImage(
        image = painterResource(R.drawable.frame_1_airplane),
